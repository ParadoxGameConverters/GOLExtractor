...
#include "../CoatsOfArms/Emblem.h"
#include "../CoatsOfArms/EmblemInstance.h"
#include "Magick++.h"
...
Magick::Image FlagCrafter::craftFlagFromCoA(const CoatOfArms& coa) const
{
	...
	// Grab subcoats
	std::vector<std::pair<CoatOfArms, Magick::Image>> subs;
...
std::pair<Magick::Image, Magick::Image> FlagCrafter::processEmblemsOnImage(const std::pair<Magick::Image, Magick::Image>& imagePair,
...
std::pair<Magick::Image, Magick::Image> FlagCrafter::processSubsOnImage(const std::pair<Magick::Image, Magick::Image>& imagePair,
...
std::pair<Magick::Image, Magick::Image> FlagCrafter::imposeEmblemInstancesOnImage(const std::pair<Magick::Image, Magick::Image>& imagePair,

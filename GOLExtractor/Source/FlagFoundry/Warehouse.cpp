...
std::pair<bool, Magick::Image> Warehouse::getCoA(const std::string& ID)
{
...
std::pair<Magick::Image, Magick::Image> Warehouse::getPattern(const CoatOfArms& coa)
{
...
std::vector<std::pair<Emblem, Magick::Image>> Warehouse::getColoredTextures(const std::vector<Emblem>& emblems)
{
	return getTextures(emblems, "colored_emblems");
}

std::vector<std::pair<Emblem, Magick::Image>> Warehouse::getTexturedTextures(const std::vector<Emblem>& emblems)
{
	return getTextures(emblems, "textured_emblems");
}

std::vector<std::pair<Emblem, Magick::Image>> Warehouse::getTextures(const std::vector<Emblem>& emblems, const std::string& directoryName)
{
	std::vector<std::pair<Emblem, Magick::Image>> toReturn;
...
bool coloredImage::operator==(const coloredImage& rhs)
{
